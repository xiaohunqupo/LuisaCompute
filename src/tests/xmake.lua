...
test_proj("test_motion_blur_mesh_2", "integration/runtime/motion_blur/test_mesh_2.cpp", true)
test_proj("test_motion_blur_mesh_3", "integration/runtime/motion_blur/test_mesh_3.cpp", true)
