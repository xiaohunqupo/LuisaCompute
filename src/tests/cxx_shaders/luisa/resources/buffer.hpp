...
struct [[builtin("buffer")]] Buffer<int32, cache_flags> {
	...
	[[callop("BUFFER_VOLATILE_READ")]] int32 volatile_load(uint32 loc);
	[[callop("BUFFER_WRITE")]] void store(uint32 loc, int32 value);
	[[callop("BUFFER_VOLATILE_WRITE")]] void volatile_store(uint32 loc, int32 value);
...
struct [[builtin("buffer")]] Buffer<uint32, cache_flags> {
	...
	[[callop("BUFFER_VOLATILE_READ")]] uint32 volatile_load(uint32 loc);
	[[callop("BUFFER_WRITE")]] void store(uint32 loc, uint32 value);
	[[callop("BUFFER_VOLATILE_WRITE")]] void volatile_store(uint32 loc, uint32 value);
...
struct [[builtin("buffer")]] Buffer<float, cache_flags> {
	...
	[[callop("BUFFER_VOLATILE_READ")]] float volatile_load(uint32 loc);
	[[callop("BUFFER_WRITE")]] void store(uint32 loc, float value);
	[[callop("BUFFER_VOLATILE_WRITE")]] void volatile_store(uint32 loc, float value);
...
struct [[builtin("buffer")]] Buffer<void, cache_flags> {
	...
	template<typename T>
	[[callop("BYTE_BUFFER_VOLATILE_READ")]] T volatile_byte_load(uint32 byte_index);
	template<typename T>
	[[callop("BYTE_BUFFER_WRITE")]] void byte_store(uint32 byte_index, const T& val);
	template<typename T>
	[[callop("BYTE_BUFFER_VOLATILE_WRITE")]] void volatile_byte_store(uint32 byte_index, const T& val);
	[[ignore]] Buffer() = delete;
	[[ignore]] Buffer(Buffer const&) = delete;
	[[ignore]] Buffer& operator=(Buffer const&) = delete;
};
