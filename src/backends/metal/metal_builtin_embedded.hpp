...
#define luisa_compute_metal_builtin_kernels ((unsigned char *)_binary_metal_builtin_kernels_metal_start)
...
#define luisa_compute_metal_device_lib ((unsigned char *)_binary_metal_device_lib_metal_start)
