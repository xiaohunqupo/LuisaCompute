...
int main(int argc, char *argv[]) {
    ...
    // LuisaCompute backends are loaded by name, so argv[1] selects CUDA, DX,
    // Metal, or CPU. The optional --offline flag disables the window and saves
    // a PNG instead, which is useful on CI or remote machines.
