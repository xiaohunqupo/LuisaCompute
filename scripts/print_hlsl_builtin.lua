...
-- 'accel_process', 'accel_process_vk', 'bindless_upload', 'bindless_upload_vk'
local files_list = {'bc6_encode_block', 'bc6_header', 'bc6_trymode_g10cs',
                    ...
                    'bindless_common', 'auto_diff', "reduce", 'accel_process_vk.dxil', 'load_bdls.dxil', 'load_bdls_vk.dxil', 'set_accel4.dxil'}
