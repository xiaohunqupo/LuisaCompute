...
local files_list = {'accel_process', 'accel_process_vk', 'bindless_upload', 'bindless_upload_vk', 'typed_bindless_upload', 'typed_bindless_upload_vk', 'bc6_encode_block', 'bc6_header', 'bc6_trymode_g10cs',
