...
class LUISA_XIR_API LoopInst final : public ControlFlowMergeMixin<DerivedTerminatorInstruction<LoopInst, DerivedInstructionTag::LOOP>> {
...
class LUISA_XIR_API SimpleLoopInst final : public ControlFlowMergeMixin<DerivedTerminatorInstruction<SimpleLoopInst, DerivedInstructionTag::SIMPLE_LOOP>> {
public:
